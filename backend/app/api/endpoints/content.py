        ...
        "services": [
            {
                "name": "Rooms",
                "icon": "🏨",
                "description": "Luxury rooms with stunning sea views",
                "link": "/rooms",
            },
            {
                "name": "Beach",
                "icon": "🏖️",
                "description": "Private beach with VIP cabanas",
                "link": "/beach",
            },
            {
                "name": "Restaurant",
            ...
            },
            {
                "name": "Cafe",
                "icon": "☕",
                "description": "Relax with premium coffee & tea",
                "link": "/cafe",
            },
            {
                "name": "Activities",
                "icon": "🎯",
                "description": "Water sports and entertainment",
                "link": "/activities",
            },
            {
                "name": "Events",
        ...
        "facilities": [
            {
                ...
                "description": "120 rooms and suites with stunning sea views",
            },
            {
                "icon": "🏖️",
                "title": "Private Beach",
                "description": "500m of pristine Red Sea coastline",
            },
            {
                "icon": "🍽️",
                "title": "Fine Dining",
                "description": "3 restaurants serving international cuisine",
            },
            {
                "icon": "☕",
                "title": "Beachfront Cafe",
                "description": "Premium coffee and light bites",
            },
            {
                "icon": "🏊",
                "title": "Swimming Pools",
                "description": "4 pools including infinity pool",
            },
            {
                "icon": "💆",
                "title": "Spa & Wellness",
                ...
                "items": [
                    {
                        ...
                        "price": 12,
                        "description": "Ful medames, falafel, eggs, pita bread, tahini",
                    },
                    {
                        "name": "Continental",
                        "price": 15,
                        "description": "Pastries, cold cuts, cheese, fresh fruit, coffee",
                    },
                    {
                        "name": "Sea View Pancakes",
                        "price": 14,
                ...
                "items": [
                    {
                        ...
                        "price": 28,
                        "description": "Fresh catch with lemon butter sauce, grilled vegetables",
                        "badge": "Chef's Choice",
                    },
                    {
                        "name": "Lamb Tagine",
                        "price": 32,
                        "description": "Tender lamb with apricots, almonds, and Moroccan spices",
                    },
                    {
                        "name": "Ribeye Steak",
                        "price": 45,
